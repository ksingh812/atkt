...
?>
	...
	$theme = wp_get_theme();
	$site_credits = sprintf( __( '&copy; %1$s %2$s. Site by %3$s.', 'flat-bootstrap' ), 
		date ( 'Y' ),
		'<a href="' . esc_url( home_url( '/' ) ) . '" rel="home">' . get_bloginfo( 'name' ) . '</a>',
		'<a href="http://www.yuvinghotra.com" rel="profile" target="_blank">Yuvin Ghotra</a>'
	);
