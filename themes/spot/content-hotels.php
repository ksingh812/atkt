			...
			<div class="<?php echo $image_class; ?>" style="background-image: url('<?php echo $image_url; ?>'); height:750px;">
				...
				<div id="template_searchbox">
					...
					<ul class="sb_searchformToggle">
						<li class="rs_tabs first_tab rs_air_tab" data-tab="air"><div class="rs_product_icon highlight_img" id="iconAir"></div>Flight</li>
						<li class="rs_tabs rs_hotel_tab highlight_tab" data-tab="hotel"><div class="rs_product_icon highlight_img" id="iconHotel"></div>Hotel</li>
